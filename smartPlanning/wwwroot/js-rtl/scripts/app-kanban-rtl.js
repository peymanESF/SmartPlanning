    ...
    var kanban_board_data = [
        {
            ...
            item: [
                {
                    id: "1_1",
                    title: "مشتری اکسپرس برای سفر به منظومه شمسی بیرونی بیان می کند",
                    border: "green",
                ...
                {
                    id: "1_4",
                    title: "تبلیغات روزنامه را بصورت آنلاین در کتاب محبوب رزرو کنید.",
                    border: "red",
                    dueDate: "می 3, 2019",
                    comment: 56,
                    attachment: 1,
        ...
        },
        {
            ...
            item: [
                ...
                {
                    id: "2_2",
                    title: "افراد را بر روی کارت بکشید تا این امر را نشان دهد.",
                    border: "orange",
        ...
        },
        {
            ...
            item: [
                ...
                {
                    id: "3_3",
                    title: "نوار پیشرفت bootstrap را با شماره حل کنید",
                    border: "red",
                    dueDate: "مارس 9, 2019",
                    users: [
    ...
    addBoardDefault.addEventListener("click", function () {
        ...
        if (kanbanNewBoard) {
            ...
            kanbanNewBoardData = '<div class="dropdown">' +
                ...
                '<li><a href="#!"><i class="material-icons">link</i><span class="menu-item">کپی کردن لینک</span></a></li>' +
